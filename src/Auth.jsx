...
const AuthProvider = ({ children }) => {
  ...
  const signUpSupabase = async (email, password, firstName, lastName) => {
  ...
  const signInWithOAuthSupabase = async (provider) => {
  ...
  const updateUserProfileSupabase = async (firstName, lastName) => {
